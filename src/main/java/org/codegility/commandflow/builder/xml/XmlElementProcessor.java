 ...
 * <p>
 * A command processor that creates a command pushes the command onto the command builder stack using {@link XmlCommandBuilder#pushCommand(org.codegility.commandflow.Command, String)} when processing the start of
