 ...
 */
package org.codegility.commandflow.builder.xml.v1;
...
import org.codegility.commandflow.builder.xml.FixedCommandProcessor;
...
import org.codegility.commandflow.builder.xml.XmlBuilderConfigurer;
import org.codegility.commandflow.builder.xml.XmlBuilderFactory;
...
public class XmlBuilderConfigurerV1 implements XmlBuilderConfigurer {
    ...
    static {
        InputStream is = getResourceAsStream(XmlBuilderConfigurerV1.class.getPackage(), "org.codegility.commandflow.xsd");
        try {
